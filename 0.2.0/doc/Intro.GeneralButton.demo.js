...
var GeneralButton = function (_Component) {
    _inherits(GeneralButton, _Component);

    function GeneralButton(props) {
        _classCallCheck(this, GeneralButton);

        var _this = _possibleConstructorReturn(this, (GeneralButton.__proto__ || Object.getPrototypeOf(GeneralButton)).call(this, props));
...
/***/ "./doc/Intro.GeneralButton.demo.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _GeneralButton = __webpack_require__("./doc/GeneralButton.js");

var _GeneralButton2 = _interopRequireDefault(_GeneralButton);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(__webpack_require__("./node_modules/react/index.js").createElement(
    "div",
    null,
    __webpack_require__("./node_modules/react/index.js").createElement(_GeneralButton2.default, { style: { border: '1px solid red' } }),
    "\u4F20\u9012\u6837\u5F0F",
    __webpack_require__("./node_modules/react/index.js").createElement("hr", null),
    __webpack_require__("./node_modules/react/index.js").createElement(_GeneralButton2.default, { onClick: function onClick(e) {
            console.log('既可以触发递增，也可以触发用户绑定的 onClick');
        } }),
    "\u7ED1\u5B9A onClick",
    __webpack_require__("./node_modules/react/index.js").createElement("hr", null),
    __webpack_require__("./node_modules/react/index.js").createElement(_GeneralButton2.default, { onGreaterThree: function onGreaterThree() {
            console.log('大于3');
        } }),
    "\u5927\u4E8E3\u65F6\u56DE\u8C03"
...
module.exports = __webpack_require__("./doc/Intro.GeneralButton.demo.js");
